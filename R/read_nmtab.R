...
#' }
#' @export
read_nmtab <- function(file = NULL, skip = NULL, header = NULL, nonmem_tab = TRUE) {
  ...
  # If auto mode required
    ...
    # For additional nonmem files
    test     <- readLines(file) # Find out the final result within a file
